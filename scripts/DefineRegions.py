...
def smooth_mask(pixels, nside=128, fwhm=1):
...
def planck_source_catalogue(pixels, nside=128, fwhm=1,min_latitude=0, catalogue='none', hdu_index=1, flux_threshold=1):
...
def query_arc_pixels(pixels,nside=128, ra=0, dec=0, major=1, minor=None, width=1, pa=0, radians_input = False,theta_start=0,theta_end=2*np.pi,res=12):
...
def query_elliptical_pixels(pixels,nside=128, ra=0, dec=0, major=1, minor=None, pa=0, radians_input = False,theta_start=0,theta_end=2*np.pi,res=12):
...
def threshold_mask(pixels, map=np.zeros(1), threshold=None, threshold_pc=None):
...
def subtract_elliptical_pixels(pixels,nside=128, ra=0, dec=0, major=1, minor=None, pa=0, radians_input = False,theta_start=0,theta_end=2*np.pi,res=12):
...
def latitude_cut(pixels, nside=128, latitude=0, model='>'):
...
def bad_data_mask(pixels,map=None):
    """Mask bad data.
